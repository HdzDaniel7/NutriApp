...
const s = {
  ...
  tabActive:      { background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', fontWeight: '500' },
  ...
  avatar:         { width: '56px', height: '56px', borderRadius: '50%', background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: '700', flexShrink: 0 },
  ...
  btnPrimario:    { padding: '10px', borderRadius: '20px', border: 'none', background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', fontSize: '14px', cursor: 'pointer', fontWeight: '500' },
  ...
  plantillaCheck: { fontSize: '11px', color: '#16a34a', fontWeight: '500', padding: '4px 10px 8px', background: '#f0fdf4' },
}