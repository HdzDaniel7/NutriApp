...
export default function Perfil() {
  ...
  return (
    <div>
      ...
      <div style={tabActiva === 'plantilla' ? s.perfilLayout : undefined}>
        <div style={s.card}>
        ...
        {/* Preview separado, solo en tab plantilla */}
        {tabActiva === 'plantilla' && (
          <div style={s.previewCard}>
            <div style={{ fontSize: '13px', fontWeight: '500', color: '#71717a', marginBottom: '12px' }}>
              Vista previa
            </div>
            <PreviewPDF
...
const s = {
  ...
  perfilLayout:   { display: 'grid', gridTemplateColumns: '620px 1fr', gap: '2rem', alignItems: 'start' },
  card:           { background: '#fff', border: '1px solid #e4e4e7', borderRadius: '12px', padding: '1.5rem', maxWidth: '620px' },
  previewCard:    { background: '#fff', border: '1px solid #e4e4e7', borderRadius: '12px', padding: '1.5rem' },
  ...
  plantillasGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginTop: '6px' },
