...
const s = {
  ...
  btnPrimarioSm:     { padding: '5px 12px', borderRadius: '6px', border: 'none', background: '#16a34a', color: '#fff', fontSize: '12px', cursor: 'pointer', fontWeight: '500' },
  ...
  diaHoy:            { background: '#f0fdf4', borderRadius: '6px' },
  ...
  slotLibre:         { background: '#f0fdf4', borderWidth: '1px', borderStyle: 'dashed', borderColor: '#86efac' },
...
const m = {
  ...
  diaBtnActive:{ background: '#f0fdf4', borderColor: '#86efac', color: '#16a34a', fontWeight: '500' },
}