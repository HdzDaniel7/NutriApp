...
const s = {
  ...
  modoBtnActive:    { background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', borderColor: 'transparent', fontWeight: '500' },
  ...
  iniciarBtn:       { padding: '8px 20px', borderRadius: '20px', border: 'none', background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', fontSize: '14px', cursor: 'pointer', fontWeight: '500', marginLeft: 'auto' },
  ...
  confirmarBtn:     { padding: '6px 14px', borderRadius: '20px', border: 'none', background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', fontSize: '13px', cursor: 'pointer', fontWeight: '500' },
  ...
  diaTabActive:     { background: 'linear-gradient(135deg, #22c55e, #16a34a)', color: '#fff', borderColor: 'transparent', fontWeight: '500' },
  ...
  diaTabInput:      { padding: '5px 10px', borderRadius: '20px', borderWidth: '1px', borderStyle: 'solid', borderColor: '#22c55e', fontSize: '12px', outline: 'none', width: '100px' },
  ...
  inputGuardar:     { padding: '8px 10px', borderRadius: '8px', borderWidth: '1px', borderStyle: 'solid', borderColor: '#d4d4d8', fontSize: '14px', outline: 'none' },
  inputHint:        { fontSize: '11px', color: '#a1a1aa' },
  successMsg:       { background: '#dcfce7', borderRadius: '8px', padding: '8px 12px', fontSize: '13px', color: '#15803d', marginBottom: '8px' },
}
