...
const s = {
  ...
  alimentoActive:  { background: '#f0fdf4', border: '1px solid #86efac' },
  ...
  detalleBadge:    { display: 'inline-block', fontSize: '11px', background: '#f0fdf4', color: '#16a34a', padding: '2px 10px', borderRadius: '20px', marginBottom: '1rem' },
