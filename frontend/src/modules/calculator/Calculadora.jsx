...
const s = {
  ...
  toggle:      { display: 'flex' },
  toggleBtn:   { flex: 1, padding: '7px', fontSize: '13px', cursor: 'pointer', border: '1px solid #d6d3d1', background: '#fafaf9', color: '#57534e' },
  ...
  radioCard:   { display: 'flex', gap: '10px', alignItems: 'flex-start', padding: '8px 10px', borderRadius: '6px', border: '1px solid #e7e5e4', marginBottom: '6px', cursor: 'pointer' },
  radioActive: { background: '#f0fdf4', borderColor: '#86efac' },
  ...
  objBtn:      { padding: '10px', borderRadius: '8px', border: '1px solid #e7e5e4', background: '#fff', cursor: 'pointer', textAlign: 'center' },
  objActive:   { background: '#f0fdf4', borderColor: '#86efac' },
  ...
  pill:        { padding: '5px 14px', borderRadius: '20px', border: '1px solid #e7e5e4', background: '#fafaf9', fontSize: '13px', color: '#57534e', cursor: 'pointer' },
  pillActive:  { background: '#f0fdf4', borderColor: '#86efac', color: '#16a34a', fontWeight: '500' },
